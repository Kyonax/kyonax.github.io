    ...
    'kyo-web': {
      ...
      'content-data': {
        ...
        'experience': {
          'agile-engine': {
            ...
            'specs': '2025-PRESENT <strong>AGILE-ENGINE</strong> // <strong>MADISON-REED</strong> REMOTE-VILLAVICENCIO///COLOMBIA',
            'description': 'Senior Software Engineer at AgileEngine working on the <strong>Vue 3</strong> e-commerce redesign for Madison Reed, focused on scalable <strong>CMS-driven</strong> component architecture, performance optimization, and conversion rate improvement. Each delivery phase is structured around upfront architecture decisions, TDD unit tests, <strong>Playwright</strong> e2e testing, and Lighthouse performance baselines. Designed an AI-assisted development workflow and integrated third-party SDKs with CMS-driven abstraction layers.',
            'bullets': '<li>Built reusable <strong>Vue 3</strong> components and Pug templates with Stylus styling driven by CMS configuration on the Express SSR + MongoDB-backed CMS stack (Vite with legacy Webpack 4) and documented them in <strong>Storybook</strong>, so routine page tuning and content updates shipped through CMS without engineering tickets, while the same blocks scaled to new pages with minimal rework.</li><li>Improved <strong>SEO</strong> and <strong>AEO (Answer Engine Optimization)</strong> by identifying the data carrying business value on each page and exposing it through <strong>JSON-LD</strong>, validated SSR output, and a semantic, ADA-compliant h1 → h2 → h3 structure, so search bots and AI engines parse intent fast and accurately, improving rich-result eligibility, AI-engine citations, and conversion.</li><li>Integrated third-party SDKs (Birdeye location reviews, Dynamic Yield A/B testing, Dash Hudson UGC, Google Auth / FedCM SSO, Segment analytics), wrapping each in CMS-driven abstraction layers so A/B experiments, feature rollouts, and integration tuning ran through configuration instead of a new PR per change.</li><li>Drafted architecture decisions and extended ACs to cover edge cases on further implementations for a <strong>Vue 3 e-commerce redesign</strong>, wrote TDD unit tests with Vitest upfront, codified style rules in ESLint, and added <strong>Playwright</strong> e2e suites, keeping PR reviews focused on substance and avoiding rework from missed ACs or Code Quality.</li><li>Orchestrated an <strong>AI-assisted development workflow</strong> by abstracting repetitive patterns into custom skills, scripts, and tooling that automate the work accurately, picking Claude Code, GPTel (Emacs), GPT, Gemini, Grok, or LiteLLM per task by strengths and efficiency, so engineering time went into real design decisions instead of repetitive scaffolding, cutting scaffolding effort by ~40%.</li>',
          ...
          'zeronet': {
            ...
            'bullets': "<li>Built custom libraries targeting recurring frontend performance bottlenecks (image-heavy rendering, asset loading, repetitive setup work), consistently achieving <strong>100/100 Lighthouse</strong> scores across client sites and removing the need to re-solve the same problems.</li><li>Built an internal <strong>AI development platform</strong> in <strong>FastAPI (Python)</strong> that fronts LiteLLM as an async gateway with provider routing, retries, and SSE token streaming, plus an agent-backend layer hosting custom skills as callable endpoints, so the same orchestration powers editor clients, CLI scripts, and CI tasks across every project without re-implementing model plumbing.</li><li>Designed modular project architectures and <strong>SASS/SCSS</strong> styling systems built on design patterns and naming conventions, so codebases stayed maintainable through feature growth and refactors didn't require ripping out foundational decisions.</li>",
          ...
          'softtek': {
            ...
            'specs': '2023-2025 <strong>SOFTTEK</strong> REMOTE-VILLAVICENCIO///COLOMBIA',
          ...
          'cr-senior-fullstack': {
            ...
            'bullets': '<li>Developed high-performance landing pages, e-commerce sites and microservices for multiple clients using <strong>Next.js, React.js, Vue.js</strong>, Nest.js, Node.js, Redux, AntDesign, and SASS/SCSS. Applied SSR/SSG/ISR patterns in Next.js, GraphQL - Apollo for data-driven pages, and <strong>WebSockets</strong> for real-time features when required.</li><li>Led and Collaborated with multiple teams, adapting to various Agile Methodologies like Agile and SCRUM, while ensuring adherence to project specific Code Guidelines, doing Pull Request - PRs, and mentoring developers. Enforced PR review standards, and introduced testing with <strong>Jest</strong>.</li><li>Translated UI/UX mockups, templates into dynamic, responsive, and user focus frontend implementations, aligning with the expected business goals.</li>',
          ...
          'cr-growth': {
            ...
            'bullets': "<li>Drove brand awareness and engagement on Twitter, Instagram, Discord and YouTube by executing targeted growth strategies increasing online presence, follower engagement, and customer acquisition.</li><li>Leveraged analytics to refine content strategies, boosting brand loyalty and optimizing campaign performance.</li><li>Optimized user flows by implementing custom components, custom elements, and custom hooks, to improve website's functionalities, to deliver faster rendering websites.</li>",
      ...
      'landing': {
        ...
        'hero': {
          ...
          'summary': '8+ years building scalable, high-performance e-commerce and web platforms in Vue 3, React, Next.js, TypeScript, and Node.js, working fully remote from Latin America. Currently Senior Full-Stack & Frontend Engineer at <strong>AgileEngine</strong>, building for <strong>Madison Reed</strong>. Founder & Independent Engineer at <strong><a href="https://github.com/zeronet-labs" target="_blank" rel="noopener noreferrer">Zerønet Labs</a></strong>. Specialized in ADA/WCAG accessibility, SEO/AEO, and AI-assisted development systems.',
    ...
    'kyo-web': {
      ...
      'content-data': {
        ...
        'experience': {
          'agile-engine': {
            'role': 'SENIOR SOFTWARE ENGINEER (FRONTEND)',
            'specs': '2025-PRESENTE <strong>AGILE-ENGINE</strong> // <strong>MADISON-REED</strong> REMOTO-VILLAVICENCIO///COLOMBIA',
            'description': 'Ingeniero de Software Senior en AgileEngine trabajando en el rediseño <strong>Vue 3</strong> del e-commerce de Madison Reed, enfocado en arquitectura escalable guiada por CMS, optimización de rendimiento y mejora de conversiones. Cada fase de entrega está estructurada alrededor de decisiones de arquitectura anticipadas, tests unitarios TDD, suites e2e con <strong>Playwright</strong> y baselines de rendimiento con Lighthouse. Diseñé un flujo de trabajo asistido por IA e integré SDKs de terceros con capas de abstracción guiadas por CMS.',
            'bullets': '<li>Construí componentes <strong>Vue 3</strong> reutilizables y templates Pug con estilos Stylus gobernados por configuración CMS sobre el stack Express SSR + CMS basado en MongoDB (Vite con Webpack 4 legacy), documentados en <strong>Storybook</strong>, para que ajustes rutinarios de página y actualizaciones de contenido se entregaran a través del CMS sin tickets de ingeniería, mientras los mismos bloques escalaban a nuevas páginas con mínimo retrabajo.</li><li>Mejoré <strong>SEO</strong> y <strong>AEO (Answer Engine Optimization)</strong> identificando los datos con valor de negocio en cada página y exponiéndolos a través de <strong>JSON-LD</strong>, salida SSR validada, y una estructura h1 → h2 → h3 semántica con cumplimiento ADA, para que los bots de búsqueda y motores de IA interpretaran la intención de manera rápida y precisa, mejorando elegibilidad para rich results, citaciones de motores de IA y conversión.</li><li>Integré SDKs de terceros (Birdeye reseñas de ubicaciones, Dynamic Yield A/B testing, Dash Hudson UGC, Google Auth / FedCM SSO, Segment analytics), envolviendo cada uno en capas de abstracción gobernadas por CMS para que experimentos A/B, despliegues de funcionalidades y ajustes de integración corrieran por configuración en lugar de un PR nuevo por cambio.</li><li>Redacté decisiones de arquitectura y extendí ACs para cubrir casos límite en futuras implementaciones de un rediseño e-commerce en <strong>Vue 3</strong>, escribí pruebas unitarias TDD con Vitest desde el inicio, codifiqué reglas de estilo en ESLint, y agregué suites e2e con <strong>Playwright</strong>, manteniendo las revisiones de PRs enfocadas en lo sustancial y evitando retrabajo por ACs incumplidos o problemas de calidad de código.</li><li>Orquesté un <strong>flujo de desarrollo asistido por IA</strong> abstrayendo patrones repetitivos en skills personalizados, scripts y herramientas que automatizan el trabajo con precisión, eligiendo Claude Code, GPTel (Emacs), GPT, Gemini, Grok o LiteLLM por tarea según fortalezas y eficiencia, para que el tiempo de ingeniería se dedicara a decisiones reales de diseño en lugar de scaffolding repetitivo, reduciendo el esfuerzo en scaffolding y boilerplate en ~40%.</li>',
            'tools': '<strong>vue3 - pug - stylus - vite - vitest - playwright - eslint - express - mongodb - storybook - json-ld - lighthouse - claude-code - gptel - litellm - birdeye - dynamic-yield - dash-hudson - segment - fedcm</strong>',
          },
          'zeronet': {
            ...
            'bullets': '<li>Construí librerías personalizadas para cuellos de botella recurrentes de rendimiento frontend (renderizado con muchas imágenes, carga de assets, tareas repetitivas de setup), alcanzando consistentemente puntuaciones <strong>100/100 en Lighthouse</strong> en sitios de cliente y eliminando la necesidad de resolver los mismos problemas en cada nueva entrega.</li><li>Construí una <strong>plataforma interna de desarrollo asistido por IA</strong> en <strong>FastAPI (Python)</strong> que envuelve LiteLLM como gateway asíncrono con ruteo entre proveedores, reintentos y streaming SSE de tokens, junto a una capa de agent-backend que expone skills personalizados como endpoints invocables, para que la misma orquestación alimente clientes en editor, scripts de CLI y tareas de CI en cada proyecto sin reimplementar la integración con modelos.</li><li>Diseñé arquitecturas modulares de proyecto y sistemas de estilos en <strong>SASS/SCSS</strong> basados en patrones de diseño y convenciones de nombres, para que las bases de código se mantuvieran sostenibles a través del crecimiento de funcionalidades y los refactors no requirieran arrancar las decisiones fundamentales.</li>',
            'tools': '<strong>reactjs - nextjs - vuejs - vite - webpack - symfony - nestjs - express - nodejs - python - typescript - postgresql - mariadb - mysql - docker - graphql - rest - semantic-release - github-actions - sass/scss</strong>',
          },
          'softtek': {
            'role': 'SENIOR FULL-STACK ENGINEER',
            'specs': '2023-2025 <strong>SOFTTEK</strong> REMOTO-VILLAVICENCIO///COLOMBIA',
          ...
          'cr-growth': {
            ...
            'bullets': '<li>Impulsé el reconocimiento de marca y la interacción en Twitter, Instagram, Discord y YouTube ejecutando estrategias de crecimiento dirigidas, incrementando presencia digital, engagement de seguidores y adquisición de clientes.</li><li>Utilicé analíticas de GA4 para revisar el rendimiento de contenido y guiar iteraciones en campañas y mejoras del sitio web basadas en datos reales de usuarios.</li><li>Optimicé flujos de usuario implementando componentes personalizados, elementos y hooks para mejorar las funcionalidades de cada sitio y reducir tiempos de renderizado.</li>',
            'tools': '<strong>aws - ec2 - apache - mysql - php - reactjs - nodejs - typescript - sass - twitter - youtube - discord - payu - cybersource</strong>',
          },
        },
        'projects': {
      ...
      'landing': {
        ...
        'hero': {
          ...
          'summary': '8+ años construyendo plataformas web y e-commerce escalables, de alto rendimiento en Vue 3, React, Next.js, TypeScript y Node.js, trabajando en remoto desde Colombia. Actualmente Ingeniero Full-Stack & Frontend Senior en <strong>AgileEngine</strong>, desarrollando para <strong>Madison Reed</strong>. Fundador e Ingeniero Independiente en <strong><a href="https://github.com/zeronet-labs" target="_blank" rel="noopener noreferrer">Zerønet Labs</a></strong>. Especializado en accesibilidad ADA/WCAG, SEO/AEO y sistemas de desarrollo asistido por IA.',
        ...
        'faq': {
          ...
          'items': {
            ...
            'projects-companies': {
              ...
              'answer': 'Actualmente trabajo con <strong>AgileEngine</strong> en la plataforma e-commerce de <strong>Madison Reed</strong>, una marca de belleza de Estados Unidos. Antes fui Frontend Lead en <strong>Softtek</strong> en una migración completa de plataforma e-commerce, y antes en Cabeza-Rota construyendo productos web para múltiples clientes. A través de <a href="https://github.com/zeronet-labs" target="_blank" rel="noopener">Zerønet Labs</a> también trabajo directamente con startups. El historial completo está en la sección de Experiencia.',
            },
            'hiring-criteria': {
